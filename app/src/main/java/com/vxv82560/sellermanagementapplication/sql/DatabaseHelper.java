...
/**
 * This class is used to insert user's into DB
 * @author veenapaniv
 */
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   // private static final String COLUMN_USER_ID = "UserID";
    ...
    private String CREATE_PRODUCT_TABLE = "CREATE TABLE "
            + TABLE_INVENTORY + " ("
            ...
            + COLUMN_AMOUNT + " FLOAT, "
            + COLUMN_SHIPPING_RATE + " FLOAT, "
            + COLUMN_LAST_UPDATED + " DATETIME, "
            + COLUMN_USER_ID + " INTEGER"+ ");";

    // drop table sql query
    private String DROP_USER_TABLE = "DROP TABLE IF EXISTS " + TABLE_USER;
    private String DROP_PRODUCT_TABLE = "DROP TABLE IF EXISTS " + TABLE_INVENTORY;
    /**
     * Constructor
     * 
     * @param context
    ...
    public void onCreate(SQLiteDatabase db) {
        Log.e("I'm trying to create","creating"+CREATE_PRODUCT_TABLE);
    ...
    public void addUser(User user) {
        //get a writable instance of the databse
        SQLiteDatabase db = this.getWritableDatabase();
        //Build the query using ContentValues which helps ContentResolver process
    ...
    public User getUser(String Email) {
        ...
        // Read data, cursor is simplied to one line
        if (cursor.moveToFirst()) {
            user.setId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(COLUMN_USER_ID))));
            user.setEmail(cursor.getString(cursor.getColumnIndex(COLUMN_USER_EMAIL)));
            user.setName(cursor.getString(cursor.getColumnIndex(COLUMN_USER_NAME)));
